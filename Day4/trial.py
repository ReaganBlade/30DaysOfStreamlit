...
# Create differences from the median for values (numeric columns)
...
if add_sidebar == 'Aggregate Metrics':
    ...
    df_agg_diff_final = df_agg_diff[['Video title','Publish_date','Views','Likes','Subscribers','Shares','Comments added',
